...
- **Clickable fields**: Tap addresses to open in Apple Maps or Google Maps, tap phone numbers to call/text, tap email addresses to compose email
...
- Job posting URL (tap to open)
- Applied date & time with intuitive date and time pickers
- Status tracking:
...
- **Statistics**: See application stats at a glance (Total, Applied, Rejected, Interview counts)
...
Track and compare job offers:

**Offer Tracking:**
- Link offers to specific job applications
- Track salary range (e.g., "$80,000 - $100,000")
- Track benefits (e.g., "Health, Dental, 401k match")
- Work location: Remote, Hybrid, or Onsite
- Notes section for additional details
- View and edit existing offers
- Quick navigation to linked job application
...
Comprehensive interview preparation toolkit:
...
- **Save**: Save documents to your device
- **Rename**: Give documents descriptive names
- **Toggle Active/Inactive**: Organize your document collection
...
- All screens respect your chosen color theme
...
- **Page breaks**: Each day starts on a new page for clean printing
